...
//        #2980b9
          ...
          //colors: "#43C6AC", /* fallback for old browsers */
          //colors: "-webkit-linear-gradient('to left', '#43C6AC' , '#F8FFAE')", /* Chrome 10-25, Safari 5.1-6 */
          //colors: "linear-gradient('to left', '#43C6AC', '#F8FFAE')"}; /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        // options['colors'] = ['#f0f3f4', '#f7dc6f','#abebc6','#76d7c4','#5dade2','#2980b9'];
        options['colors'] = [ '#F8FFAE','#43C6AC'];
