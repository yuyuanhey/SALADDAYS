        ...
        $.each(value, function (key, val) {
            if(key != "date"){
              if(key == "year"){
                ...
                TableRow += "<td style='width:480px;text-align:left;padding-left:30px'><a href='http://internationalnewsstation.tw/?event="+val+"' style='text-decoration:none;' target='_blank'>" + val + "</a></td>";
              }
            }
        });
        TableRow += "</tr>";
...
//        #2980b9
        ...
        var options = {
               ...
               backgroundColor:{fill: 'white', stroke: 'none', strokeWidth: 5},
               // backgroundColorStroke:'yellow',
               // defaultColor: 'pink',
               colorAxis: {minValue:1, maxValue:40, colors: ['#F8FFAE', '#43C6AC']}
          };
...
target1 = document.getElementById('target1').style.display == 'none';
        ...
        vedio2  = document.getElementById('vedio2').style.display  == 'none';
        map     = document.getElementById('map').style.display     == 'none';
        if(target1 && target2 && target3 && vedio1 && vedio2 && map){
        ...
        function showBlock(id){ 
            ...
            document.getElementById('threeM').style.color = "#563d12";

            document.getElementById('oneYd').style.display = "none";
            document.getElementById('oneY').style.backgroundColor = "#FFE153";
            document.getElementById('oneY').style.boxShadow = "0 7px #999";
            document.getElementById('oneY').style.color = "#563d12";
            ...
            document.getElementById(buttonId).style.boxShadow = "0 4px #666";
            document.getElementById(buttonId).style.color = "white";
        }
        function showMessage(value){
            var showMap = "heatMap" + value;
            for(i=0; i<=12; i++){
                var index = "heatMap" + i.toString();
                document.getElementById(index).style.display = "none";
            }
            if(value == '0')
                document.getElementById("message").innerHTML = "　";
            else
                document.getElementById("message").innerHTML = value+"月份分層設色圖　　　";
        ...
        function showBarLineChart(value){
          ...
          for(i=1; i<=12; i++){
            var index = "BarLine" + i.toString();
            document.getElementById(index).style.display = "none";
          }
          document.getElementById(showBarLine).style.display = "block";
        }